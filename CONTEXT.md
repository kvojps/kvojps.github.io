...
uma coleção que não cabe empilhada. Usada nas seções de aplicativos e de trabalhos, em todas as
larguras. Distinta do carrossel, que neste site é só o transbordo dos botões de filtro: a esteira
move conteúdo, o carrossel move controles.
